#!/usr/bin/env python
"""
@author Jesse Haviland (for NEO component of this script)

Trying to implement some sort of RRT (maybe classical RRT for now) with NEO
to see improvement in performance without a large increase cost of computation.
"""
import swift
...
# RRT PART #
X_dimensions = np.array([(0, 1), (0, 1), (0, 1)])  # dimensions of Search Space
...
def step():
    print(s0.T[:3,3]) # example of obj position per step
